...
urlpatterns = [
    ...
    path('usuarios/<int:usuario_id>/', views.detalle_o_editar_o_eliminar_usuario),

    # Menu routes
    path('menu/', views.listar_o_crear_menu_item, name='listar_o_crear_menu_item'),
    path('menu/<int:menu_id>/', views.detalle_o_editar_o_eliminar_menu_item),

    # Order routes
    path('ordenes/', views.listar_o_crear_orden, name='listar_o_crear_orden'),
    path('ordenes/<int:orden_id>/', views.detalle_o_editar_o_eliminar_orden),

    # OrderMenu routes
    path('ordenmenu/', views.listar_o_crear_order_menu, name='listar_o_crear_order_menu'),
    path('ordenmenu/<int:orden_menu_id>/', views.detalle_o_eliminar_order_menu),
    
    # Employee routes
    path('empleados/', views.listar_o_crear_empleado, name='listar_o_crear_empleado'),
    path('empleados/<int:empleado_id>/', views.detalle_o_editar_o_eliminar_empleado),
